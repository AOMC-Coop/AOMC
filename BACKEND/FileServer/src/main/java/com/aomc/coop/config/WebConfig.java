...
//
//import com.aomc.coop.interceptor.OpenAPITokenInterceptor;
...
//                .addPathPatterns("/api/files/upload/**").excludePathPatterns("/api/team/accept").excludePathPatterns("/api/files/*");
//    }
//
//    @Override
